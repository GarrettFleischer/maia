...
const schema = z.object({
  q: z.string().describe("Comprehensive research question (one call, combine angles)"),
  enableCitations: z.boolean().optional(),
  enableEntities: z.boolean().optional(),
  language: z.string().optional().describe("Response language e.g. en, de"),
  country: z.string().optional().describe("Country for results e.g. us, de"),
});
