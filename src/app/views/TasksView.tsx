...
/**
 * @fileoverview Tasks (Kanban) view: task board with columns and cards.
 * Rendered inside the app shell so state is preserved when switching tabs.
 * @module app/views/TasksView
 */
...
/**
 * @brief Task board content (no header). Rendered inside app shell.
 */
